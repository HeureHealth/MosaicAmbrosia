...
// To span the hospital name, vectors from the customer_name.js file
	...
	var mainchart_header_nation = document.getElementById("mainchart_header_nation");
	var mainchart_header_region = document.getElementById("mainchart_header_region");
	var mainchart_header_division = document.getElementById("mainchart_header_division");
	var mainchart_header_state = document.getElementById("mainchart_header_state");
	var mainchart_header_hrr = document.getElementById("mainchart_header_hrr");
	//mainchart_header.innerHTML = vector1_expansion.innerHTML + " Opportunities" + " - " + level1_expansion.innerHTML + " Market";
	if (mainchart_header_nation !== null){
	mainchart_header_nation.innerHTML = level1_expansion.innerHTML + " Market";
	}
	if (mainchart_header_region !== null){
	mainchart_header_region.innerHTML = level2_expansion.innerHTML + " Market";
	}
	if (mainchart_header_division !== null){
	mainchart_header_division.innerHTML = level4_expansion.innerHTML + " Market";
	}
	if (mainchart_header_state !== null){
	mainchart_header_state.innerHTML = level6_expansion.innerHTML + " Market";
	}
	if (mainchart_header_hrr !== null){
	mainchart_header_hrr.innerHTML = level7_expansion.innerHTML + " Market";
	}
	...
	pnmainchart_header.innerHTML = " Market Position";
	...
	hospscore_header.innerHTML = customer_info.hosp_name + " Score";
	...
	avgaspscore_header.innerHTML = " Avg Aspirant Score";
	...
	avgchallscore_header.innerHTML = " Avg Challenger Score";
	...
	avgleadscore_header.innerHTML = " Avg Leader Score";
//}	